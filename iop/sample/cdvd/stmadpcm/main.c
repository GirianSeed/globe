...
// ローカルメモリ内の配置
unsigned char  ring_buf[2048 * 80] __attribute__((aligned (4)));
unsigned char  sbuf[_BUF_SIZE] __attribute__((aligned (4)));

#define _ADPCM_MARK_START 0x04
#define _ADPCM_MARK_LOOP  0x02
#define _ADPCM_MARK_END   0x01

#define _AdpcmSetMarkSTART(a,s) { *((unsigned char *)((a)+1)) = (_ADPCM_MARK_LOOP | _ADPCM_MARK_START); *((unsigned char *)((a)+0x10+1)) = _ADPCM_MARK_LOOP; *((unsigned char *)((a)+(s)-0x0f)) = _ADPCM_MARK_LOOP; }

#define _AdpcmSetMarkEND(a,s) { *((unsigned char *)((a)+1)) = _ADPCM_MARK_LOOP;  *((unsigned char *)((a)+0x10+1)) = _ADPCM_MARK_LOOP; *((unsigned char *)((a)+(s)-0x0f)) = (_ADPCM_MARK_LOOP | _ADPCM_MARK_END); }

#define _AdpcmSetMarkSTARTpre(a,s) { *((unsigned char *)((a)+1)) = (_ADPCM_MARK_LOOP | _ADPCM_MARK_START); *((unsigned char *)((a)+0x10+1)) = _ADPCM_MARK_LOOP;  }

#define _AdpcmSetMarkENDpre(a,s) { *((unsigned char *)((a)+(s)-0x0f)) = (_ADPCM_MARK_LOOP | _ADPCM_MARK_END); }

...
#define sceEENETCTL_PP_ModemDisconnecting 403	/* Line is now disconnecting */
...
#define sceEENETCTL_P_AutoconfTentative	604	/* DAD is now performing */
#define sceEENETCTL_P_AutoconfDuplicate	605	/* Duplicate address was detected, still continue DAD */
#define sceEENETCTL_P_AutoconfDown	606	/* Interface is invalid */

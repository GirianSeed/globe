...
The Sample Program for the HiG (High Level Graphics) Library 
...
< Description of the Sample >
	...
	Plugin refers to the ones provided by SCEI.
...
SAMPLE0
	An object display sample using the output data of es2hig.
...
< Data >
        The model data used in this sample has been exported by 

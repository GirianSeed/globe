...
　EE Coreのみを用いて行列演算、透視変換等を行う数学関数を実装し、3Dグラフ
ィックスに必要な数学の基礎について理解を深めます。また、このような数学関数
をvu0,vu1に実装する際の手助けとなるよう、basic3d vu0版およびvu1版で用いて
いる関数と同等の関数を実現します。さらに、演算結果を直接GSに渡すパケットを
作成することにより、DMAの動作とともにGSの動作の基本仕様について確認します。

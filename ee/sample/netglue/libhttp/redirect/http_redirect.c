...
int main(int argc, char **argv){
	...
	if(argc < 2){
		printf("usage: http_redirect.elf url\n");
		ERR_STOP;
	}
	...
	case sceHTTPC_UseProxy:
		locations = (char **)sceHTTPParseLocations(response);
		if (locations == NULL){

...
//        停止しておく必要があります。
extern inline void sceIpuBCLR(int bp)
{
    DPUT_IPU_CMD(SCE_IPU_BCLR | bp);
}
...
extern inline void sceIpuIDEC(int ofm, int dte, int sgn,
					int dtd, int qsc, int fb)
{
...
extern inline void sceIpuBDEC(int mbi, int dcr, int dt, int qsc, int fb)
{
...
//        ます。
extern inline void sceIpuVDEC(int tbl, int fb)
{
...
extern inline void sceIpuFDEC(int fb)
{
    DPUT_IPU_CMD(SCE_IPU_FDEC | fb);
}
...
extern inline void sceIpuSETIQ(int iqm,  int fb)
{
...
extern inline void sceIpuSETVQ(void)
{
    DPUT_IPU_CMD(SCE_IPU_SETVQ);
}
...
extern inline void sceIpuCSC(int ofm, int dte, int mbc)
{
...
extern inline void sceIpuPACK(int ofm, int dte, int mbc)
{
...
//        ます。
extern inline void sceIpuSETTH(int th1, int th0)
{
...
//        を読み出します。
extern inline u_int sceIpuGetFVdecResult(void)
{
    return DGET_IPU_CMD();
}
...
// [返値] なし
// [解説] IPU をリセットします。
extern inline void sceIpuReset(void)
{
...
extern inline int sceIpuIsBusy(void)
{
    return (int)DGET_IPU_CTRL() < 0;
}
...
extern inline int sceIpuIsError(void)
{
    return DGET_IPU_CTRL() | IPU_CTRL_ECD_M;
}

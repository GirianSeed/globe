...
Sample program to connect to an HTTP server and receive encoded chunk data 
using libhttp

< Description of the Sample >
	This sample program uses libhttp to connect to an HTTP 
	server and receive encoded chunk data.
...
< Activating the Program >
	$ make                          : Links libhttp by compiling 
					  the program
	$ dsedb -r run http_chunk.elf <URL> : Executes the program
...
< Operation Overview >
	...
	2. Uses sceHTTPSetOption() to specify a callback function when 

...
sceVu0FVECTOR camera_rot = { 2.0f, 0.2f, 0, 0 };

sceVu0FVECTOR light0 = { 0.0, 1.5, 0.5, 0 };
sceVu0FVECTOR light1 = { 1.5, -0.5, 0.5, 0 };
sceVu0FVECTOR light2 = { -1.5, -0.5, 0.5, 0 };

sceVu0FVECTOR color0  = { 0.3, 0.3, 0.8, 0 };
sceVu0FVECTOR color1  = { 0.8, 0.3, 0.3, 0 };
sceVu0FVECTOR color2  = { 0.3, 0.8, 0.3, 0 };
...
void CopyMatrix(float *dst, sceVu0FMATRIX src)
{
    int i,j;

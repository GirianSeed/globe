...
Sample program to connect to an HTTP server using libhttp 
...
< Description of the Sample >
	...
	connection in non-blocking mode.
...
< Activating the Program >
	$ make                          : Links libhttp by compiling 
					  the program
	$ dsedb -r run http_test.elf command <URL> [post-data] : Executes 
							      the program
...
< Operation Overview >
	...
	2. Uses sceHTTPSetOption() to specify non-blocking.

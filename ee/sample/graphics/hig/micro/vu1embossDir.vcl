...
;**********Micro Init-Block *****************
	...
	MOVE.x _sce_light,_sce_dirNLightVect[0]
	ADDx.y _sce_light,vf00,_sce_dirNLightVect[1]
	ADDx.z _sce_light,vf00,_sce_dirNLightVect[2]
	fwInitClip
;********************************************
...
BUMP_vertex_loop:
	...
	fwDirLight "SCE_VERTEXC","SCE_NOAMBIENT",_sce_diffFact

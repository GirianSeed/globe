...
//Transpose 3x3 part of 4x4 matrix
// mtx: matrix
// tmtx: transposed matrix
void TransposeMatrix3(float mtx[4][4],float tmtx[4][4])
{
...
// v0: vector
// v1: vector
// v2: outer producted vector(v0xv1)
void OuterProduct(float v0[4], float v1[4], float v2[4])
{
...
//set floating vector in VU packet
// VUad: VU packet address
// vect: floating vector
void set_VUvector(u_int *VUad,float vect[4])
{
        VUad[0] = *(u_int *)&vect[0];
        VUad[1] = *(u_int *)&vect[1];
...
//set Taylor expansion's coefficients in VU packet
// VUad: VU packet address
void set_sincos_Taylor_coeff(u_int *VUad)
{
        *(float*)(VUad)=0;

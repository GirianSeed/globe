 ...
 *  --------------------------------------------------------------------
 *      0.10            July,14,1999     ywashizu    add recognizing GsVersion
...
extern short sceGsVersion;          // to know GS version
...
int main(){
	...
	DPUT_IPU_CTRL(IPU_CTRL_VAL);         	// Set IPU_CTRL

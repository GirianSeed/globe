...
SCULLV_GIFTAG:
	...
	ibeq 		_sce_triangleMask,_sce_prim,SCULLV_vertex_loop
	iaddiu		_sce_bfcMask,vi00,0x20
	ibeq		_sce_triangleStripMask,_sce_prim,SCULLV_vertex_loop
	isub		_sce_noCull,_sce_prim,_sce_triangleMask
	ibltz		_sce_noCull,SNOCULLV_cull	
...
SCULLV_vertex_loop:
	...
	lq 		_sce_vColor,_sce_vert_RGBA(_sce_in_p)				; load diff. color
	...
	fwLoadNLightVect 103,104,105,_sce_dirNLightVect
 	fwDirLight "SCE_PHONG","SCE_AMBIENT",_sce_diffFact,_sce_specFact

	;_sce_dColor loaded but vcl will remove it !
	...
	fwCalcColorSum "SCE_PHONG","SCE_CLAMP",_sce_vColor,_sce_diffFact,_sce_vColor,_sce_aColor,_sce_eColor,_sce_specFact,_sce_sColor  ;use _sce_vColor as output to save alpha
...
; increment pointers, decrement counter
	...
	ibne  		_sce_nVerts,vi00, SCULLV_vertex_loop   
;**************************************************************************************	
SCULLV_done_ver:

	mtir 		_sce_eopFlag,_sce_gifTagx
	ibgez 		_sce_eopFlag,SCULLV_GIFTAG
...
; increment pointers, decrement counter
	...
	ibne  		_sce_nVerts,vi00, SNOCULLV_loop   
;*************************************************************		
SNOCULLV_done:

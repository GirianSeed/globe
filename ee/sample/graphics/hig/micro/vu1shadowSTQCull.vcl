...
SHADOWSTQC_GIFTAG:
	...
	ibeq 		_sce_triangleMask,_sce_prim,SHADOWSTQC_vertex_loop
	iaddiu		_sce_bfcMask,vi00,0x20
	ibeq		_sce_triangleStripMask,_sce_prim,SHADOWSTQC_vertex_loop
...
; increment pointers, decrement counter
	...
	ibne  		_sce_nVerts,vi00, SHADOWSTQC_vertex_loop   
;**************************************************************************************

SHADOWSTQC_done:

	mtir 		_sce_eopFlag,_sce_gifTagx
	ibgez 		_sce_eopFlag,SHADOWSTQC_GIFTAG

 ...
 *  --------------------------------------------------------------------
 *       1.00     2002/03/14  mka, ksh first version
 *       1.10     2003/04/15  ksh      u_int *net_buf to void *net_buf
 */
...
PRIVATE	int 	add_connection( sceSifMClientData *pcd, void *net_buf, sceInetParam_t *iparam )
{
...
PRIVATE	int 	close_connection( sceSifMClientData *pcd, void *net_buf, PCONN p )
{
	int 	r;
...
PRIVATE	int 	tcp_echo_server( sceSifMClientData *pcd, void *net_buf, sceInetParam_t *iparam )
{
	sceInetPollFd_t	*fds;
	CONN	*p;
	CONN	*q;
...
PUBLIC	void	do_tcp_echo_server( sceSifMClientData *pcd, void *net_buf, int backlog )
{

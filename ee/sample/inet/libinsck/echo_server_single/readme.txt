...
Single-threaded Echo Server Sample That Runs on Top of the libinsck Library


<Description>
	This program is a sample echo server that uses libinsck. It performs a TCP passive open operation from the ee, receives data from a connected client, then sends the data directly back to the client.

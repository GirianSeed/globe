 ...
 *  --------------------------------------------------------------------
 *       1.0.0     Dec,12,2002    komaki              first version
 *       1.1.0     Apr,22,2003    komaki              add erx handling
 */
...
int	main(int argc, char **argv){
	...
	if((ret = http_abort_init(argc, argv)) < 0){
		scePrintf("http_abort_init() failed.\n");
		ERR_STOP;
	}

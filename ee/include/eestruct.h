...
// bit definition
//	
#define GS_XYOFFSET_0FX_M  		(0xffff<< 0)
#define GS_XYOFFSET_0FY_M  		(0xffff<<32)

#define GS_XYOFFSET_0FX_O  		( 0)
#define GS_XYOFFSET_0FY_O  		(32)
...
#define GS_TEX0_TH_M 	(0x000f<<30)
#define GS_TEX0_TCC_M 	(0x0001<<34)
#define GS_TEX0_TFX_M 	(0x0003<<35)
#define GS_TEX0_CBP_M 	(0x3fff<<37)
#define GS_TEX0_CPSM_M 	(0x000f<<51)
#define GS_TEX0_CSK_M 	(0x0001<<55)
#define GS_TEX0_CSA_M 	(0x001f<<56)
#define GS_TEX0_CLD_M 	(0x0007<<61)
...
#define GS_TEX2_CBP_M 	(0x3fff<<37)
#define GS_TEX2_CPSM_M 	(0x0f  <<51)
#define GS_TEX2_CSM_M 	(0x01  <<55)
#define GS_TEX2_CSA_M 	(0x1f  <<56)
#define GS_TEX2_CLD_M 	(0x07  <<61)
...
#define GS_MIPTBP1_TBP2_M 	(0x3fff<<20)
#define GS_MIPTBP1_TBW2_M 	(0x3f  <<34)
#define GS_MIPTBP1_TBP3_M 	(0x3fff<<40)
#define GS_MIPTBP1_TBW3_M 	(0x3f  <<54)
...
#define GS_MIPTBP2_TBP5_M 	(0x3fff<<20)
#define GS_MIPTBP2_TBW5_M 	(0x3f  <<34)
#define GS_MIPTBP2_TBP6_M 	(0x3fff<<40)
#define GS_MIPTBP2_TBW6_M 	(0x3f  <<54)
...
#define GS_CLAMP_MINV_M 	(0x3ff<<24)
#define GS_CLAMP_MAXV_M 	(0x3ff<<34)
...
#define GS_SCISSOR_SCAY0_M  	(0x7ff<<32)
#define GS_SCISSOR_SCAY1_M  	(0x7ff<<48)
...
#define GS_FRAME_FBMSK_M  		(0xffffffff<<32)
...
#define GS_BITBLTBUF_DBP_M  			(0x3fff<<32)
#define GS_BITBLTBUF_DBW_M  			(0x3f  <<48)
#define GS_BITBLTBUF_DPSM_M  			(0x3f  <<56)
...
#define GS_TRXPOS_DSAX_M  			(0x7ff<<32)
#define GS_TRXPOS_DSAY_M  			(0x7ff<<48)
#define GS_TRXPOS_DIR_M  			(0x03 <<59)
...
#define GS_TRXREG_RRH_M  			(0xfff<<32)
...
#define SCE_GS_SET_PMODE(en1, en2, crtmd, mmod, amod, \
		slbg, alp, nfld, exvwins, exvwine, evsyncmd) \
	((u_long)(en1)            | ((u_long)(en2) << 1)      | \
	((u_long)(crtmd) << 2)    | ((u_long)(mmod) << 5)     | \
	((u_long)(amod) << 6)     | ((u_long)(slbg) << 7)     | \
	((u_long)(alp) << 8)      | ((u_long)(nfld) << 16)    | \
	((u_long)(exvwins) << 32) | ((u_long)(exvwine) << 42) | \
	((u_long)(evsyncmd) << 52))
...
#define SCE_GS_SET_DISPLAY(dx, dy, magh, magv, dw, dh) \
	((u_long)(0x28c+dx)    | \
	((u_long)((SceGsInterMode?50:25) + dy) << 12) | \
	((u_long)(magh) << 23) | ((u_long)(magv) << 27) | \
	((u_long)(dw) << 32)   | ((u_long)(dh) << 44))

#define SCE_GS_SET_DISPFB1	SCE_GS_SET_DISFB
#define SCE_GS_SET_DISPFB2	SCE_GS_SET_DISFB

...
sceVu0FVECTOR light0 = { -5.0, 3.5, 2.0, 0 };
sceVu0FVECTOR light1 = { -0.0, -1.0, -0.0, 0 };
sceVu0FVECTOR light2 = { 5.0, -0.5, -2.5, 0 };

sceVu0FVECTOR plight0 = { 5.0, -4.0, -5.0, 1.0 };
sceVu0FVECTOR plight1 = { -5.0, -4.0, -5.0, 1.0 };
sceVu0FVECTOR pcolor0 = { 0.05, 0.15, 0.8, 0 };
sceVu0FVECTOR pcolor1 = { 0.8, 0.15, 0.05, 0 };

sceVu0FVECTOR color0  = { 0.77, 0.75, 0.75, 1 };
sceVu0FVECTOR color1  = { 0.55, 0.63, 0.55, 1 };
sceVu0FVECTOR color2  = { 0.15, 0.1, 0.10, 1 };
...
extern u_int My_plight_code __attribute__((section(".vudata")));
extern u_int My_plight2_code __attribute__((section(".vudata")));

...
3次元ポリゴンにIPUを用いてデコードしたテクスチャを張ったサンプル

<サンプルの解説>
	sample ディレクトリの中の pkt/cube のサンプルに
	ipu/ezmovie のサンプルをテクスチャとして張ったものです。
	動作に関してはcubeのサンプルを、動画に関してはezmovieの
	サンプルを参照してください。
	本サンプルではIPUでデコードしたデータをテクスチャバッファに
	DMA転送し、テクスチャとして表示しています。

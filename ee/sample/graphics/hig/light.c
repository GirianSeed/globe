...
void lightinit(sceHiPlugMicroData_t *md)
{
    ...
    static sceVu0FVECTOR col[4]={{0.8f, 0.8f, 0.8f, 30.0f},{0.6f, 0.6f, 0.6f, 30.0f},{0.4f, 0.4f, 0.4f, 30.0f},{0.2f, 0.2f, 0.2f, 0.0f}};

    for(i=0;i<MAX_LIGHT;i++){		/* light type 3 */
	for(j=0;j<MAX_LIGHT+1;j++){	/* light number 3+1 ambient */

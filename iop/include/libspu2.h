...
//--- for SPU2
extern unsigned long  SpuSetCore (unsigned long ); //spu2
extern unsigned long SpuGetCore (void ); //spu2
extern void SpuSetReverbEndAddr (unsigned long eea );
extern unsigned long SpuGetReverbEndAddr (void );
...
extern unsigned long SpuAutoDMAWrite (unsigned char *addr, unsigned long size, unsigned long mode);
extern void SpuAutoDMAStop (void); //spu2
extern long SpuAutoDMAGetStatus (void);  //spu2
...
extern SpuTransferCallbackProc SpuAutoDMASetCallback (SpuTransferCallbackProc func); //spu2
...
extern unsigned long SpuStSetCore (unsigned long core ); //spu2
#if defined(_LANGUAGE_C_PLUS_PLUS) || defined(__cplusplus) || defined(c_plusplus)
}

...
sceVu0FVECTOR camera_p = { 0, 0, -10, 0 };
sceVu0FVECTOR camera_zd = { 0, 0, 1, 1 };
sceVu0FVECTOR camera_yd = { 0, 1, 0, 1 };
sceVu0FVECTOR camera_rot = { -0.1*PI, 0, 0, 0 };
...
extern u_int My_scissor_code __attribute__((section(".vudata")));
extern u_int My_cube_start __attribute__((section(".vudata")));
extern u_int My_cube_scissor_tag __attribute__((section(".vudata")));
extern u_int My_torus_start __attribute__((section(".vudata")));
extern u_int My_torus_scissor_tag __attribute__((section(".vudata")));
extern u_int My_grid_start __attribute__((section(".vudata")));
extern u_int My_grid_scissor_tag __attribute__((section(".vudata")));

...
#define sceEENETCTL_IEV_Timeout  8   /* timeout */
#define sceEENETCTL_IEV_GetAddr  9   /* get IP addr(IPv6) */
#define sceEENETCTL_IEV_LoseAddr 10  /* lose IP addr(IPv6) */
#define sceEENETCTL_IEV_UpCompleted 11 /* user up request for "ipversion"
                                         completed. */
#define sceEENETCTL_IEV_DownCompleted 12 /* user down request for "ipversion"
                                         completed. */

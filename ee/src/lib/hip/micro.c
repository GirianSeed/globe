 ...
 *                        All Rights Reserved.
 */
/*	$Id: micro.c,v 1.18 2001/10/29 05:29:55 kaneko Exp $	*/
#include <eekernel.h>
#include <stdlib.h>
#include <eeregs.h>
#include <libgraph.h>
...
typedef struct {
    ...
    sceHiPlugMicroLight_t	lightgrp[3];
...
static void micro_set_data(sceHiPlug *plug, MICRO_FRAME	*mf, u_int *daddr)
{
    ...
    */
    ...
    /* set initial data */
#if 0
    sceVu0CopyMatrix(((sceHiPlugMicroData_t *)daddr)->init_data, data.mat);
#else
    /* dont over-write other data */
    ((sceHiPlugMicroData_t *)daddr)->init_data[0][3] = data.mat[0][3];
    ((sceHiPlugMicroData_t *)daddr)->init_data[1][0] = data.mat[1][0];
    ((sceHiPlugMicroData_t *)daddr)->init_data[1][1] = data.mat[1][1];
    ((sceHiPlugMicroData_t *)daddr)->init_data[1][2] = data.mat[1][2];
#endif
}

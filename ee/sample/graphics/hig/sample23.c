...
void SAMPLE23_init(void)
{
    ...
    if (sceHiGsDisplaySize(_dispw, _disph)!= SCE_HIG_NO_ERR) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
    ...
    if (AAbuf_tbl==NULL) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
...
void SAMPLE23_exit(void)
{
	...
	!= SCE_HIG_NO_ERR) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
    if (sceHiGsDisplaySize(640, 224)!= SCE_HIG_NO_ERR) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
}
...
static void init_disp(void)
{
    ...
    if (gsenv_disp==NULL) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
    ...
    if (gsctx_disp_aaon==NULL) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
    ...
    if (gsctx_disp_aaoff==NULL) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
...
static void init_draw(void)
{
    ...
    if (gsctx_draw_aaon==NULL) error_handling(__FILE__,__LINE__,sceHiErrState.mes);
    ...
    if (gsctx_draw_aaoff==NULL) error_handling(__FILE__,__LINE__,sceHiErrState.mes);

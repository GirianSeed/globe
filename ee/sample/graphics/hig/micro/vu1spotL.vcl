...
LSPOT_vertex_loop:
	...
	fwSpotLight "SCE_LAMBERT","SCE_AMBIENT",_sce_diffFact
	fwCalcColorSum "SCE_LAMBERT","SCE_CLAMP",_sce_vColor,_sce_diffFact,_sce_vColor,_sce_aColor,_sce_eColor  ;use _sce_vColor as output to save alph7a

...
extern sceSifQueueData rpc_qd;		/* SIF RPC request queue data */
extern sceSifServeData rpc_sd;		/* SIF RPC server data */

extern volatile int thid_cb;		/* Thread ID for callback thread */

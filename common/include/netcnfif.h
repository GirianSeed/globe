...
int sceNetcnfifGetCount(char *fname, int type);
int sceNetcnfifGetList(char *fname, int type, sceNetcnfifList_t *addr, int size);
int sceNetcnfifLoadEntry(char *fname, int type, char *usr_name, sceNetcnfifData_t *addr);
int sceNetcnfifLoadEntryAuto(char *fname, int type_with_flags, char *usr_name, sceNetcnfifData_t *addr);
int sceNetcnfifAddEntry(char *fname, int type, char *usr_name);
int sceNetcnfifEditEntry(char *fname, int type, char *usr_name, char *new_usr_name);
int sceNetcnfifDeleteEntry(char *fname, int type, char *usr_name);
int sceNetcnfifSetLatestEntry(char *fname, int type, char *usr_name);
int sceNetcnfifDeleteAll(char *fname);
int sceNetcnfifCheckCapacity(char *fname);
int sceNetcnfifCheckAdditionalAT(char *additional_at);
int sceNetcnfifCheckSpecialProvider(char *fname, int type, char *usr_name);

...
static char	filename[NUM][40] = {"data/block.bin","data/plane1.bin","data/dpyramid.bin","data/ellipsoid.bin","data/plane2.bin"};

void SAMPLED_init(void)
{
    sceHiErr	err;
    sceHiType	type;
    
    char	framename[NUM][12] = {"Frame","Frame","Frame","Frame","Frame"};
    char       gjk_filename[NUM][40] = {"data/cblock.bin","data/cplane1.bin","data/cdpyramid.bin","data/cellipsoid.bin","data/cplane2.bin"};
    int	i;
...
#define STEPS 4
    simulation(bodylist,NUM,1.0f/(60.0f*STEPS),STEPS,t,&mem,calc_force);
    t+=1.0f/60.0f;

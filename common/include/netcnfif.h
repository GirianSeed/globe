 ...
 *       1.3            2002.03.23      tetsu       Add sceNETCNFIF_INVALID_ARG
 *       1.4            2002.05.05      tetsu       Add sceNETCNFIF_AOL_CONFIGURATION
...
#define SCE_NETCNFIF_CHECK_SPECIAL_PROVIDER (10)  /* 特殊プロバイダの設定であるかどうかをチェック */
...
#define sceNETCNFIF_AOL_CONFIGURATION (-20)  /* AOL の設定を追加・編集しようとしている */
#define sceNETCNFIF_NO_DATA           (-100) /* データが設定されてない */
#define sceNETCNFIF_INVALID_ARG       (-101) /* 引数が不正 */

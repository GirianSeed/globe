 ...
 *                        All Rights Reserved.
 */
/*	$Id: access.c,v 1.11 2002/12/05 10:10:59 kaneko Exp $	*/
#include <eekernel.h>
#include <stdlib.h>
#include <stdio.h>
#include <stdarg.h>
...
u_int *sceHiPlugAnimeGetFrame(sceHiPlugAnimeHead_t *h, int idx)
{
    return (int *)(h+1)+idx;
}
...
/*********************************************************************************
 *				SCE_HIP_HRCHY_MATRIX
 *********************************************************************************/
sceHiPlugHrchyMatrix_t *sceHiPlugHrchyGetMatrix(sceHiPlugHrchyHead_t *h, int idx)
{
    return (sceHiPlugHrchyMatrix_t *)(h+1)+idx;
}

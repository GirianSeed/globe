...
#define PKT_SEND_READY	0x01			// packet status in list
...
typedef struct {
	...
	int		   	 stat;
	DECI2_HDR	*deci2;
} PKT, PKTLIST;							// packet list

extern int connected2ee;				// status for connection with EE
extern int sampleProtoOpened;			// status for sample protocol 

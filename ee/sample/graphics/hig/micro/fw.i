...
.macro  fwGetScale  scale,mat,matInv
	mMulVecByMat3x3 _sce_scale[0],\mat[0],\matInv
	mMulVecByMat3x3 _sce_scale[1],\mat[1],\matInv
	mMulVecByMat3x3 _sce_scale[2],\mat[2],\matInv
	move.x \scale,_sce_scale[0]
	move.y \scale,_sce_scale[1]
	move.z \scale,_sce_scale[2]
.endm

.macro  fwLoadLocalWorldRT
	; load localWorld matrix without scale!!
	lq _sce_localWorldRT[0], 4(VI00)				
	lq _sce_localWorldRT[1], 5(VI00)					
 	lq _sce_localWorldRT[2], 6(VI00)
	lq _sce_localWorldRT[3], 3(VI00)
.endm
.macro	fwLocalScreen
...
.macro fwClip param="TRIANGLE_TRIANGLESTRIP_FAN"
	 ...
	 clipw.xyz	_sce_c_ver,_sce_clip_offsets
        ...
        .AIF "\param" EQ "TRIANGLE"
         fcand         vi01,0x003ffff
        .AENDI

        .AIF "\param" EQ "TRIANGLE_TRIANGLESTRIP"
         fcand         vi01,0x003ffff
        .AENDI

        .AIF "\param" EQ "TRIANGLE_TRIANGLESTRIP_FAN"
         fcand          vi01,0x003ffff
         iand   _sce_clipTriangle,vi01,_sce_triangleClipSwitch 
         fcand vi01,0xfff
         ior  vi01,vi01,_sce_fanFirstVertexClip
         iand   _sce_clipFan,vi01,_sce_fanClipSwitch 
         iadd   vi01,_sce_clipFan,_sce_clipTriangle
        .AENDI

        .AIF "\param" EQ "TRIANGLESTRIP_FAN"
         fcand          vi01,0x003ffff
         iand   _sce_clipTriangle,vi01,_sce_triangleClipSwitch
         fcand vi01,0xfff
         ior  vi01,vi01,_sce_fanFirstVertexClip
        ...
        .AIF "\param" EQ "POINT_LINE_LINESTRIP"
         fcand   vi01,0xfff
         iand    _sce_clipLine,vi01,_sce_lineClipSwitch
         fcand   vi01,0x3f
         iand    _sce_clipPoint,vi01,_sce_pointClipSwitch
         iadd    vi01,_sce_clipPoint,_sce_clipLine
        .AENDI

        .AIF "\param" EQ "POINT_LINE_LINESTRIP_TRIANGLE_TRIANGLESTRIP_FAN"
         fcand   vi01,0x3ffff
         iand   _sce_clipTriangle,vi01,_sce_triangleClipSwitch
         fcand   vi01,0xfff
         iand    _sce_clipLine,vi01,_sce_lineClipSwitch
         ...
         iand    _sce_clipPoint,vi01,_sce_pointClipSwitch
         iadd    vi01,_sce_clipPoint,_sce_clipLine
         iadd    vi01,vi01,_sce_clipTriangle
         iadd    vi01,vi01,_sce_clipFan
        .AENDI  
.endm
...
.macro fwBFC param="default"
	.AIF "\param" EQ "local"
		...
		;addiu 		_sce_minusMask2, VI00, 0x00
		...
		;OPMULA.xyz 	ACC,_sce_nDelta,_sce_oDelta      
		;OPMSUB.xyz 	_sce_polygonNormal,_sce_oDelta,_sce_nDelta 		;outer prod.
	...
	.AELSE
		iaddiu 		_sce_minusMask, VI00, 0x0020		; calculate innerprod.
		;iaddiu 		_sce_minusMask, VI00, 0x0000
		...
		;opmula.xyz	ACC,_sce_oldDelta,_sce_newDelta			; in screen_space
		;opmsub.xyz	_sce_bfcDir,_sce_newDelta,_sce_oldDelta
...
.macro fwInitPointLineLineStrip
 
        iaddiu          _sce_pointClipSwitch,vi00,1
        iaddiu          _sce_lineClipSwitch,vi00,0
        ibeq            _sce_prim,vi00,___sce_local_lable\@    ;check if it is a point
        iaddiu          _sce_pointClipSwitch,vi00,0
        iaddiu          _sce_lineClipSwitch,vi00,1
___sce_local_lable\@:
.endm
 
.macro fwInitAllGsPrimClip
        iaddiu          _sce_pointClipSwitch,vi00,1
        ...
        isubiu          _sce_temp,_sce_prim,2         ;check if it is a line or linestrip
        iblez           _sce_temp,___sce_local_lable\@
        iaddiu          _sce_lineClipSwitch,vi00,0
        iaddiu          _sce_triangleClipSwitch,vi00,1
 
        isubiu          _sce_temp,_sce_prim,4        ;check if it is a triangle or trianglestrip
        iblez           _sce_temp,___sce_local_lable\@
 
        iaddiu          _sce_triangleClipSwitch,vi00,0
        iaddiu          _sce_fanClipSwitch,vi00,1

        lq      _sce_vrt1,_sce_vert_XYZ(_sce_in_p)      
        mulax           ACC,_sce_localScreen[0],_sce_vrt1 ; for Clip
        madday          ACC,_sce_localScreen[1],_sce_vrt1
        maddaz          ACC,_sce_localScreen[2],_sce_vrt1
        maddw           _sce_firstClipPoint,_sce_localScreen[3],vf00
        div             q,vf00w,_sce_firstClipPointw
        MULq.xyz        _sce_firstClipPoint,_sce_firstClipPoint,Q
 
        sub.xy         _sce_c_firstVer,_sce_firstClipPoint,_sce_clip_offsets
        subw.z         _sce_c_firstVer,_sce_clip_offsets,_sce_firstClipPoint
        mul.xy         _sce_c_firstVer,_sce_c_firstVer,_sce_clip_scale
        clipw.xyz      _sce_c_firstVer,_sce_clip_offsets
        fcand  vi01,0x3f
        iadd           _sce_fanFirstVertexClip,vi01,vi00  
 
___sce_local_lable\@:
 
.endm                  

.macro fwInitFan param="default" param2="default"
	...
	.AIF "\param" EQ "local" 
	move.xyz	_sce_firstPoint,_sce_vrt   ; for BFC

        mulax           ACC,_sce_localScreen[0],_sce_vrt ; for Clip
        madday          ACC,_sce_localScreen[1],_sce_vrt
        maddaz          ACC,_sce_localScreen[2],_sce_vrt
        maddw           _sce_firstClipPoint,_sce_localScreen[3],vf00
        div             q,vf00w,_sce_firstClipPointw
	...
	.AELSE
	mulax		ACC,_sce_localScreen[0],_sce_vrt ; for BFC
	madday		ACC,_sce_localScreen[1],_sce_vrt
	maddaz		ACC,_sce_localScreen[2],_sce_vrt
	...
	div 		q,vf00w,_sce_firstPointw
        ...
        .AIF "\param" NE "noclip"       
        sub.xy         _sce_c_firstVer,_sce_firstPoint,_sce_clip_offsets ; for Clip
        subw.z         _sce_c_firstVer,_sce_clip_offsets,_sce_firstPoint
        mul.xy         _sce_c_firstVer,_sce_c_firstVer,_sce_clip_scale
        clipw.xyz      _sce_c_firstVer,_sce_clip_offsets 
        fcand  vi01,0x3f
        iadd           _sce_fanFirstVertexClip,vi01,vi00
...
.macro fwResetClipSwitches 
       iaddiu _sce_pointClipSwitch,vi00,0
       iaddiu _sce_lineClipSwitch,vi00,0 
       iaddiu _sce_triangleClipSwitch,vi00,0 
       iaddiu _sce_fanClipSwitch,vi00,0 
       iaddiu _sce_fanFirstVertexClip,vi00,0
.endm

.macro fwInitGifTag mode="default"
 	...
 	.AIF "\mode" EQ "TME_ON"
	IADDIU  _sce_TME,VI00,0x10
	IOR     _sce_attribute,_sce_attribute,_sce_TME
	.AENDI
 	.AIF "\mode" EQ "TME_OFF"
	IADDIU  _sce_TME,VI00,0xffef
	IAND     _sce_attribute,_sce_attribute,_sce_TME
	.AENDI
	...
	iaddiu	_sce_triangleStripMask,VI00,0x0004
        ...
        fwResetClipSwitches  ; vcl will remove it if Clipping is not used!!
.endm

...
<Description of the Sample>
	...
	transfer function in the interim sound library, librspu2.
	Set the name of PCM file in PCM_FILENAME and the size of file
	in PCM_SIZE in order to reproduce freeform waveforms.

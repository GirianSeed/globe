 ...
 */
#define SCE_ATOK_CONFIG_KAJIINPUT       (0x00000001UL)	/* 漢字入力モード */
...
*/
/* SCE_ATOK_CONFIG_KAJIINPUT : 漢字入力モード */
#define SCE_ATOK_KAJIINPUT_ROMAN      (1)		/* ローマ字漢字 */
#define SCE_ATOK_KAJIINPUT_KANA       (2)		/* かな入力漢字 */
#define SCE_ATOK_KAJIINPUT_HANTROUGH  (3)		/* 半角スルー   */
/* SCE_ATOK_CONFIG_KANDSPTYPE : 入力文字種*/
#define SCE_ATOK_KANDSPTYPE_HIRA      (0)		/* ひらがな入力     */
#define SCE_ATOK_KANDSPTYPE_ZENKANA   (1)		/* 全角カタカナ入力 */
#define SCE_ATOK_KANDSPTYPE_ZENRAW    (2)		/* 全角無変換入力   */
#define SCE_ATOK_KANDSPTYPE_HANKANA   (3)		/* 半角カタカナ入力 */
#define SCE_ATOK_KANDSPTYPE_HANRAW    (4)		/* 半角無変換入力   */

...
#endif
{
	...
	/* DMApacket area */
	dpmem[0] = (u_int *)memalign(64, sizeof(u_int)*20*4*NBALLS + 16);
	dpmem[1] = (u_int *)memalign(64, sizeof(u_int)*20*4*NBALLS + 16);

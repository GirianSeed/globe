...
sceVu0FVECTOR color0  = { 0.8, 0.8, 0.8, 1 };
sceVu0FVECTOR color1  = { 0.8, 0.8, 0.8, 1 };
sceVu0FVECTOR color2  = { 0.8, 0.8, 0.8, 1 };
...
int main()
{
    ...
    *(u_long *)&db.clear1.rgbaq =
	...
	if(!toggle && (pad.button & SCE_PADstart)){
	    init_object();  // replay start
	    toggle = 1;
	}else if(!(pad.button & SCE_PADstart)){toggle = 0;}

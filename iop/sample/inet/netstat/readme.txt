...
For example, the sample program /usr/local/sce/ee/sample/inet/libnet/echo_server is started in a separate window.

	$ cd /usr/local/sce/ee/sample/inet/libnet/echo_server
	$ make

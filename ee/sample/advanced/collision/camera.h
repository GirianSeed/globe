...
static inline void Vu1MicroSetWorldScreen(u_int *mic, sceVu0FMATRIX mat)
{  sceVu0CopyMatrix((float (*)[4])(&mic[0]), mat);}
 
static inline void Vu1MicroSetWorldClip(u_int *mic, sceVu0FMATRIX mat)
{  sceVu0CopyMatrix((float (*)[4])(&mic[(sizeof(sceVu0FMATRIX)>>2)]), mat);}
 
static inline void Vu1MicroSetClipScreen(u_int *mic, sceVu0FMATRIX mat)

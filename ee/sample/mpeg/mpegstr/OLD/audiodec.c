...
int audioDecStart(AudioDec *ad)
{
	...
	SPU_AUTODMA_LOOP | SPU_AUTODMA_START_ADDR,
...
int audioDecPause(AudioDec *ad)
{
    ...
    //
    ad->iopPausePos = (sceSpu2Remote(1, rSpuAutoDMAStop ) & 0x00FFFFFF)
    			- ad->iopBuff;
    ...
    // Clear SPU2 buffer
    //
    sceSpu2Remote (1, rSpuSetTransferStartAddr, 0x4000);
    sceSpu2Remote (1, rSpuWrite0, 0x1000);
}
...
// Resume
//
int audioDecResume(AudioDec *ad)
{
    return audioDecStart(ad);
}

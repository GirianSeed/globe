...
<Description of the Sample>
	...
	The program is for the voice pronunciation of SPU2 from EE using 
	the interim sound library, librspu2. Tests for DMA and IRQ 
	callback are possible optionally.

	In order to exchange the tone data, specifies VAG file and the 
	file size in VAG_FILENAME and VAG_SIZE respectively in the define 
	line of main.c.

...
int main()
{
        ...
        *(u_long *)&db.clear1.rgbaq =
        ...
        sceGsSetDefLoadImage(&gs_limage,
                             ...
                             4, 4);
        FlushCache(0);
        sceGsExecLoadImage(&gs_limage, (u_long128*) My_texture6);
        sceGsSyncPath(0, 0);
        ...
        // --- set texture environment ---
                sceGsSetDefTexEnv(&texenv.gs_tex, 0, 13340, IMAGE_SIZE / 64, SCE_GS_PSMCT16,
                          8, 8, 1, 0, 0, 0, 1);
        ...
        *(u_long *) &texenv.gs_miptbp1 = SCE_GS_SET_MIPTBP1_1(13852, 2, 13980, 1, 14012, 1);
        texenv.gs_miptbp1addr = (long) SCE_GS_MIPTBP1_1;
        *(u_long *) &texenv.gs_miptbp2 = SCE_GS_SET_MIPTBP2_1(14020, 1, 14022, 1, 14023, 1);
        ...
        while(1){
                ...
                if(pad.button & SCE_PADR1){
                        camera_p[2] -= delta*5.0f;
                        if(camera_p[2]<-100.0f) camera_p[2] = -100.0f;
                }

                if(pad.button & SCE_PADR2){
                        camera_p[2] += delta*5.0f;
                        if(camera_p[2]>-10.0f) camera_p[2] = -10.0f;
                }
                ...
                *(u_long*)&texenv.gs_tex.tex11 = SCE_GS_SET_TEX1(0, 6, 1, 5, 0, 0, -75);
                FlushCache(0);
                ...
                *(u_long*)&texenv.gs_tex.tex11 = SCE_GS_SET_TEX1(0, 0, 1, 1, 0, 0, -60);
                FlushCache(0);
                sceGsPutDrawEnv(&texenv.giftag);

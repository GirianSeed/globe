 ...
 *                        All Rights Reserved.
 */
/*	$Id: lightmap.c,v 1.2.26.1 2002/02/22 15:09:30 aoki Exp $	*/
#include <eekernel.h>
#include <stdlib.h>
#include <eeregs.h>
#include <libgraph.h>
...
static void lightmap_view(LightMap *lightmap)
{
    ...
    angle = acosf(sqrtf(mdata->lightgrp[DIR].point[0][3]));             /* spot angle */
    ...
    sceVu0CopyVector(mdata->lightgrp[DIR].vector[0], vec);
    sceVu0UnitMatrix(m);

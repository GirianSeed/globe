...
Sample Program for Obtaining a Remote File
   Using the Http Protocol in the Libinsck Library 


< Description of the Sample >
        This sample program allows the remote http port access
	to download a file using a socket library libinsck for INET
	in the EE.
	This is a socket library version of ee/sample/inet/http_get.
...
< Note >
	...
	(? is a numerical value) for each connection environment.

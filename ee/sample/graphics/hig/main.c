...
{{SCE_HIP_COMMON, SCE_HIP_FRAMEWORK, SCE_HIP_SKIN, SCE_HIG_PLUGIN_STATUS, SCE_HIP_SKIN_PLUG, SCE_HIP_REVISION}, (sceHiErr *)sceHiPlugSkin },
{{SCE_HIP_COMMON, SCE_HIP_FRAMEWORK, SCE_HIP_CAMERA, SCE_HIG_PLUGIN_STATUS, SCE_HIP_CAMERA_PLUG, SCE_HIP_REVISION}, (sceHiErr *)sceHiPlugCamera },
{{SCE_HIP_COMMON, SCE_HIP_FRAMEWORK, SCE_HIP_HRCHY, SCE_HIG_PLUGIN_STATUS, SCE_HIP_MATRIX_PLUG, SCE_HIP_REVISION}, (sceHiErr *)sceHiPlugMatrix },
{{SCE_HIP_COMMON, SCE_HIP_FRAMEWORK, SCE_HIP_ANIME, SCE_HIG_PLUGIN_STATUS, SCE_HIP_MANIME_PLUG, SCE_HIP_REVISION}, (sceHiErr *)sceHiPlugManime }
};
enum {
...
static void _disp_status(_status_t *status)
{
	...
	dma_pow = ((float)status->dma_count * 100.0f) / 9765.625f;

	draw_debug_print(1, 1, "FRAME   : %8u", status->frame);
	draw_debug_print(1, 2, "CPU POW : %3.2f%%", cpu_pow);
	draw_debug_print(1, 3, "DMA POW : %3.2f%%", dma_pow);
}

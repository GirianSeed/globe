...
void sceVif0PkOpenUpkCode(sceVif0Packet *pPacket, u_short vuaddr, u_int upkcmd, u_int cl, u_int wl, int stall);
...
void sceVif1PkOpenUpkCode(sceVif1Packet *pPacket, u_short vuaddr, u_int upkcmd, u_int cl, u_int wl, int stall);

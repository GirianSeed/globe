...
< Activating the Program >
	...
	the IOP sample (iop/sample/sif/sifrpc).
	...
	In the case of the normal termination, the data sent by the 
	server masks 0xff000000 and sends it back to the client.

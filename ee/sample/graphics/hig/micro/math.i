	...
	.macro mScaleVectorXYZ out,in,scale	
	mul.xyz \out,\in,\scale
	.endm
	...
	.macro	mMulVecByMat3x3 output, vector, matBaseName
	mulax.xyz	acc, \matBaseName[0], \vector
	madday.xyz	acc, \matBaseName[1], \vector
	maddz.xyz	\output,\matBaseName[2], \vector
	.endm

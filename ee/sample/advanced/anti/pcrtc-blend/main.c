...
int main()
{
	...
	/*  sceGsSyncV & Check ODD/EVEN:  oddeven = !sceGsSyncV(0); */
        {
          sceGsSyncV(0);
	...
	while(scePadSetMainMode(0, 0, 1, 3) !=1)	{ sceGsSyncV(0); }	// Analog Mode 
	while(scePadEnterPressMode(0, 0) !=1)		{ sceGsSyncV(0); }	// Analog Switch Mode 

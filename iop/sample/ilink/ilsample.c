...
int start ( int argc, char *argv[] )
{
  ...
  if( argc >= 0 ){
    ...
    #ifdef USE_CYCLETIMEV
    if( RegisterVblankHandler( VB_START, CYCLETIME_priority, (void*)sce1394GetCycleTimeV, (void*)&CycleTimeV ) != 0 )
      return NO_RESIDENT_END;
    #endif
    ...
    #ifdef USE_CYCLETIMEV
    if( ReleaseVblankHandler( VB_START, (void*)sce1394GetCycleTimeV ) != 0 ) return REMOVABLE_RESIDENT_END;
    #endif

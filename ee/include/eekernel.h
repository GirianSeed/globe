...
#define	HEAP_ABSOLUTE		0
#define	HEAP_RELATIVE		1
...
int Exit(int n);
void ResetEE(u_int n);		/* Future Use */
...
int DisableDispatchThread(void);	/* Future Use */
int EnableDispatchThread(void);		/* Future Use */
int ChangeThreadPriority(int, int);
int iChangeThreadPriority(int, int);
int RotateThreadReadyQueue(int);
int ReleaseWaitThread(int);		/* Future Use */
int iReleaseWaitThread(int);		/* Future Use */
...
int JoinThread(int);			/* Future Use */
void *ChangeThreadStack(void *, int, void *); /* System Use */
...
int iSetAlarm(u_short, void (*)(int, u_short, void *), void *); /* Future Use */
int ReleaseAlarm(int);
int iReleaseAlarm(int);	/* Future Use */

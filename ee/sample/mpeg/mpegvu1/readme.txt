...
PlayStation 2 Programmer Tool Runtime Library  Release 3.0
     C   opyright (C) 1999 Sony Computer Entertainment Inc.
                                        All Rights Reserved
...
The program structure is the same as the mpegstr sample program. Refer to mpegstr for details.
...
<Execution>
	...
	% make help     : help information display (the method 
			  for specifying the file name can be 
			  confirmed)
...
(b) The sample data in /usr/local/sce/data/movie/mpeg/sample.pss contains some image corruption.

...
typedef struct {	/* EE run header */
	...
	word reserved2;
	word argc;
//	char nul_terminated_argv_0[];
//	char nul_terminated_argv_1[];
//	...
//	char nul_terminated_argv_argc-1[];
} DBGP_EERUN;
...
//#define DBGP_XGKT_FLAG_VIF0	0x00000010	/* VIF0 busy (reserved) */
//#define DBGP_XGKT_FLAG_VBS1	0x00000100	/* VBS1 busy (reserved) */
#define DBGP_XGKT_FLAG_VIF1	0x00001000	/* VIF1 busy */
//#define DBGP_XGKT_FLAG_GIF	0x00010000	/* GIF  busy (reserved) */

...
extern int RegisterIntrHandler(int intrnum, int type, intr_handler func,
				void *common);
extern int ReleaseIntrHandler(int intrnum);
extern int EnableIntr( int intrnum );
extern int DisableIntr( int intrnum, int *oldstat );

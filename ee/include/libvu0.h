...
// prototypes
void  sceVu0DumpVector(char *s, sceVu0FVECTOR v);
void  sceVu0DumpMatrix(char *s, sceVu0FMATRIX m);
...
void sceVu0RotAverageNclip3(sceVu0IVECTOR *v0, sceVu0FMATRIX m0, sceVu0FVECTOR *v1, int otz);
